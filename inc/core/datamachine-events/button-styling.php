 ...
 * Button Styling
 *
 * Map datamachine-events buttons to theme button classes.
 *
...
function extrachill_events_init_button_styling() {
	add_filter( 'datamachine_events_modal_button_classes', 'extrachill_events_add_modal_button_classes', 10, 2 );
	add_filter( 'datamachine_events_ticket_button_classes', 'extrachill_events_add_ticket_button_classes', 10, 1 );
	add_filter( 'datamachine_events_more_info_button_classes', 'extrachill_events_add_more_info_button_classes', 10, 1 );
}
